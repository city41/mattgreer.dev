...
<img
	src={require('./pairing-station.svg').default.src}
	alt="pairing station diagram"
/>
...
>
> &mdash; Adrian Furnham _taken from the article linked just above_
