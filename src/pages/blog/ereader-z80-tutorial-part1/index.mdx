...
export default ({ children }) => (
	<Article
		...
		intro="How to make a simple z80 hello world app for the e-Reader"
	>
		{children}
	</Article>
);
...
<wisdom>
	For most GBA emulators, you will need to rename hello.sav to match your
	eReader rom. So if the rom is ereaderUSA.gba, rename the save file to
	ereaderUSA.sav.
</wisdom>
