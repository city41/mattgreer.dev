...
And that's all there is to this one. Obviously collision detection and avoidance is much more complex than this, as the three car example starts to show. But you'd be surprised how far this simple "steer away from each other" technique can go. Maybe later on I'll expand on this series and look into more complex scenarios and solutions in this space.
