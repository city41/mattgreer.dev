...
<figure>
	<img
		src={require('./xkcdAutomation.png').default.src}
...
<figure>
	<img
		src={require('./nggmScreenshot.png').default.src}
...
<figure>
	<img
		src={require('./demoModeButtons.png').default.src}
...
<figure>
	<img
		src={require('./rbffTitleScreen.png').default.src}
...
<figure>
	<img
		src={require('./rbffTilesInViewer.png').default.src}
...
<figure>
	<img
		src={require('./tileCloseup.png').default.src}
...
<figure>
	<img
		src={require('./rbffSameCharacters.png').default.src}
...
<figure>
	<img
		src={require('./rbff_eastSidePark.gif').default.src}
...
<figure>
	<img
		src={require('./Autoanim.gif').default.src}
...
<figure>
	<img
		src={require('./tray.png').default.src}
		alt="the sprite tray in the tool"
	/>
