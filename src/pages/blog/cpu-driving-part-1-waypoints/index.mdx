...
And with that we have a basic CPU car driving around our track. Not a bad start. In the next parts of this blog series, we'll look into [adding drifting](https://www.mattgreer.dev/blog/cpu-driving-part-2-drifting/), more cars and avoidance, as well as slowing down to take curves more realistically.
