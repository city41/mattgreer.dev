...
After I posted this article on [Bluesky](https://bsky.app/profile/did:plc:jdrmcr5kjkkgqplvypdlqc2q/post/3mle3y37zmc2v), nytpu explained why the "const" data ended up in IWRAM, it's not truly const.
...
The added const keyword tells the compiler it's a constant array of constaint pointers, and then that array ends up in the ROM as expected. Thanks nytpu!
