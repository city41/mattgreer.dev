...
<pitfall>
	...
	<p>
		Experience Balatro players will find small errors in this post and some
...
Whoa, wait a minute, Baseball Card is growing way slower. What gives? A characteristic of exponential growth is it often starts slowly. Let's say we have two uncommon jokers, so Baseball Card gives `x1.5` to each. `1.5 x 1.5` is just 2.25. It's bigger, sure, but not by much. The thing is exponential growth rate overall will always be much larger than quadratic, as long as the base of the exponent is greater than 1.
...
This graph is going to 30 rounds instead of just 10. At about round 16, the exponential scaling overtakes the quadratic and then it quick says "see ya" and just rockets out of site.
...
Baseball Card had 1.5 as its base, but Triboulet has 2. Sounds like a minor difference, but it's not. Triboulet can let scores reach astronomical levels.
...
<iframe
	...
	height={315}
	style={{ margin: '3em 0' }}
	src="https://www.youtube.com/watch?v=hMdYc5QIb4Y"
	frameBorder={0}
	allowFullScreen
></iframe>
...
It starts out slow, but don't worry, it will progress quite rapidly

<iframe
	width={560}
	height={315}
	style={{ margin: '3em 0' }}
	src="https://www.youtube.com/watch?v=OPLZ99cJhBw"
	frameBorder={0}
	allowFullScreen
></iframe>
