...
And what the heck, let's break the game! This is obviously not realistic at all. And I don't blame you if you skip ahead in the video (about 3:00 is just before the game breaks). But this hand scores so high it ends up at `naneinf`, which is NaN (not a number) raised to the infinite power. In other words, the score got too high for the game to keep track of.
