...
<pitfall>
	...
	game's size! Samples are typically huge, you need to be careful here with your
	own music.
</pitfall>
...
Now with the coding stuff out of the way, the rest of this post will walk through how I made a GBA version of Chopin's Waltz in A minor.
...
Notice how the two `C-5`s in the first column have a space between them? That is because the first two notes are 8th notes, and the C's are quarter notes.

<wisdom>
	The other things near each note are different aspects of that particular note.
	The first one, 01, means this note will play the first sample. Then "v64"
	means it will play at volume 64 (128 is the max), which is the default. The
	remaining dashes are to setup note effects and parameters for those effects.
	This is more advanced stuff that we won't cover in this post.
</wisdom>
