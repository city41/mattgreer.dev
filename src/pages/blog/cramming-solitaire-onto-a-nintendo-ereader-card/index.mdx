...
The E-Reader was a peripheral that Nintendo released for the Game Boy Advance in 2002. By scanning cards that have a dot code strip on them, you can load minigames, extra levels, animations and more.
...
I've always really liked the E-Reader and was sad it didn't do very well in America. So I thought maybe I'd take a stab at making games for it myself.
...
If you would like a card to try, you can get one for free at [retrodotcards.com](https://retrodotcards.com).
...
The z80 is already a very limited processor, and this makes it even more so. Sometimes E-Reader z80 development is downright painful. But hey, the challenge is part of the fun (right?)

The limited cpu compounded with the emulator's limitations at times made coding very challenging. I often felt like this when trying to do something
...
<wisdom>
	This feels like I was maybe changing video RAM at an unsafe time. But the z80
	emulator shields your app from this kind of stuff. You have to just ask ERAPI
	to do something and hope it goes OK.
</wisdom>
...
What I find interesting is I just whipped up a typical game engine loop on the spot, just to deal out the cards. I didn't need to hook all this into a main game loop like you do with most game development. The entire rest of the game doesn't know or even care that this happens.
...
A single E-Reader dotstrip can store 2,192 bytes of data, which is nearly 3kb. But there is some overhead with the headers, and error correction, making the actual amount of data I've been able to store on a single strip closer to 2kb. This data on the dotstrip is compressed though, which helps a lot.
...
My goal is to make many more E-Reader apps. I am hoping to build at least 10 apps and have the cards for them professionally manufactured. Hopefully packaged up in a booster pack, which would be so cool. Why? Why not. I think the E-Reader is really cool and this is a lot of fun.
