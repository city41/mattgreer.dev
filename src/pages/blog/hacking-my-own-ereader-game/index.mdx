...
<pitfall>
	Actually this is not entirely true. The e-Reader contains a z80 emulator and
	from within the emulator, the game starts at address 0x100. From outside the
	emulator, the z80 memory is very high up in the GBA's RAM. But really, that
	detail isn't important to this post. From the running e-Reader game's
	perspective, the memory starts at 0x100.
</pitfall>
