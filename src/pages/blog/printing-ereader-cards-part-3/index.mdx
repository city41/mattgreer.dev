...
<wisdom>
	Addendum, June 1st, 2025. I have no had cards manufactured for the first
	series. These cards used a different paper and have a clear coating applied.
	These cards scan *beautifully!*. Really the scan just as well as Nintendo's
	do, I'm very pleased with them.
</wisdom>
...
<wisdom>
	Addendum: I have now written a script where I can inject the svg codes into a
	file. So now I can work on the file with no problems at all, and only inject
	the data when I'm ready to print. This has solved the problem of these files
	being so hard to work with.
</wisdom>
