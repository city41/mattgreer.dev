...
<wisdom>
	Addendum, June 1st, 2025. I have now had cards manufactured for the{' '}
	<a href="https://retrodotcards.com/series-one">first series</a>. These cards
	used a different paper and also had a clear coating applied. These cards scan
	*beautifully!*. Really they scan just as well as Nintendo's do, I'm very
	pleased with them.
</wisdom>
...
<wisdom>
	...
	file. So now I can work on the file with no problems, and only inject the data
	when I'm ready to print. Now these files no longer murder my cpu.
</wisdom>
