...
It can't be ingored though. My test cards had gaps ranging from 12% to 87.5%. The different sized dots impacted scanning. The cards with a 75% dot gap had pretty small dots on them, but they would scan. However, not very well. Cards with very little gap caused the dots to really bleed together, and those would not scan at all.
