...
A neat little effect is to leave sprits out of the fading. This accomplishes a "spotlight" effect, kind of like in a play. Considering it's so cheap to do, it's a nice trick.
...
I left sprites out (`BLD_OBJ`) because although it seems like it should work, so far I've not been able to figure it out. Probably a topic for a future blog post :)
