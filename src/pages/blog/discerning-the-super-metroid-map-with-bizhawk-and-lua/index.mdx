...
<figure>
	<img
		src={require('./autoMappingScreenshot.png').default.src}
...
<figure>
	<img
		src={require('./singleBitDumpExample.png').default.src}
...
<wisdom>
	<b>March 2024 update:</b> Three years later, I improved the dumping so that
	each screenshot takes about 2 seconds. An entire dump then takes about 6
	hours. Even better, I have been able to focus the dumps as I learned more
	about the map.
</wisdom>
...
<figure>
	<img
		src={require('./mapResults.png').default.src}
...
<figure>
	<img
		src={require('./mapDumpUpdate.png').default.src}
...
<figure>
	<img
		src={require('./rightSideOfCrateria.png').default.src}
		alt="Crateria map"
		style={{ imageRendering: 'pixelated' }}
	/>
	<figcaption>
...
<wisdom>
	<b>March 2024 update:</b> I ended up using BizHawk movies instead of save
	states. A BizHawk movie is a recording of controller inputs. I was able to
	capture a movie that starts the game, presses start to enter the map, then
	presses the directional pad to move the map where it needed to be depending on
	which part of the map I was after. My BizHawk script would start this movie,
	then quickly alter the save file before the movie picked a save, and then take
	a screenshot once the movie was done. This worked very well.
</wisdom>
