...
You probably want to print rare official cards, like the Pokemon Eon Ticket. I can't help you locate the files, but when you find some you want to make sure they are `.raw` files. E-Reader cards can come in many formats, but .raw is the final one that can be turned into a dotcode image.

[Here](/helloWorld.ereader.raw) is a raw file I made of a simple test program. It has no copyright issues as I wrote it, so feel free to use it.

### Test the .raw file in mGBA

No point in making a card of a faulty file. Fire up mGBA, load up the E-Reader GBA ROM (which you can obtain by dumping your E-Reader, or, uh, you know...) and then when the E-Reader wants you to scan a card, choose "Scane e-Reader dotcodes..."
...
If this doesn't work, there is no point in going further. It won't work on a real E-Reader either.
