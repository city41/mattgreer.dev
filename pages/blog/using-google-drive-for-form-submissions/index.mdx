...
<pitfall>
    Google only accepts urlencoded form data, you can't send JSON. Alternatively you can send the values as query params on the URL, ie <pre>.../formResponse?entry.111=foo&entry.222=bar</pre>
</pitfall>
...
<img src={require('./responsePage.png')} alt="Google Form response page" />
