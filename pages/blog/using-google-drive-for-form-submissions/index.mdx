...
intro="Sometimes I build fully static websites but still want to collect some data from visitors. I don't want to bother with a server or 3rd part form submission services, so sometimes I use Google Drive."
>{children}</Article>
