...
<wisdom>
You can also have stringify format the result for you by making use of the <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify#space_argument">space argument</a>. JSON.stringify(colors, null, 2) will format the resulting string nicely.
</wisdom>
