...
<pitfall>
Technically the root is not empty, it actually contains an array of 32 nulls. Each null slot is a spot where the root can allow growth
</pitfall>

<img src={require('./vector-4-diagram.svg')} alt="diagram of a vector with 4 items" />
...
<img src={require('./vector-64-diagram.svg')} alt="diagram of a vector with 64 elements" />

here's `(apply vector (range 0 900))`

<img src={require('./vector-900-diagram.svg')} alt="diagram of a vector with 900 elements" />

and here's `(apply vector (range 0 11000))`

<img src={require('./vector-11000-diagram.svg')} alt="diagram of a vector with 11000 elements" />
...
<wisdom>
    This is the vector specific -conj method, the actual conj method we just called is <a href="https://github.com/clojure/clojurescript/blob/22dd4fbeed72398cbc3336fccffe8196c56cd209/src/cljs/cljs/core.cljs#L1115">here</a>, it uses Clojure protocols to find and invoke vector's -conj when called with a vector
</wisdom>
...
<img src={require('./vector-34-conj-diagram.svg')} alt="diagram showing a new tail being created after a conj" />
...
<img src={require('./vector-64-conj-diagram.svg')} alt="diagram showing pushing a tail into a root" />
...
<img src={require('./vector-1056-diagram.svg')} alt="diagram of a vector with a completely full root" />
...
<img src={require('./vector-1056-conj-diagram.svg')} alt="diagram showing the root growing by one level" />
...
<img src={require('./vector-traversal.svg')} alt="diagram showing traversing through a vector" />
