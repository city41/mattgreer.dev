...
<figure>
    <img src={require('./maskVsNoMask.png')} alt="example of how masking works on the Arduboy" />
...
<figure>
<img src={require('./mirroredBoomerang.png')} alt="boomerang frames being mirrored" />
...
<figure>
<img src={require('./invertedMapTiles.png')} alt="example of inverted map tiles" />
...
<figure>
<img src={require('./bombResize.png')} alt="large bomb and small bomb" />
...
<figure>
<img src={require('./titleScreen.png')} alt="title screen of the game" />
</figure>
