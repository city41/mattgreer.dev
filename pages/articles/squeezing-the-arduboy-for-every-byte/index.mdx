...
export default ({ children }) => <Article {...meta} img={require('./feature.png')} socialMediaImg={require('./twitter.png')} pixelateImage
...
<pitfall>
This is not how Zelda stored its dungeons, as <a href="https://old.reddit.com/r/gamedev/comments/9eyhni/squeezing_the_arduboy_for_every_byte/e5t7a3j/">Borncoding pointed out to me on Reddit.</a> However, seeing the dungeons laid out this way did inspire me to put them all in one map, so I am grateful for the image regardless.
</pitfall>
